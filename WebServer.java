...
public class WebServer {
    ...
    private void handleTimeRequest(HttpExchange exchange) throws IOException {
        ...
        objeto.servidor2 = dtf.format(LocalDateTime.now());
        ...
        String activeServer = checkStatus(serializado);
        aggregator.sendTasksToWorkers(Arrays.asList(activeServer), serializado);
    }
    ...
    private void imprimeTiempoPromedio(Demo objeto) {
        ...
        int minutoPromedio = (minutosServidor1 + minutosServidor2 + minutosServidor3 + minutosServidor4)
                / cantidadServidores;
        int segundoPromedio = (segundosServidor1 + segundosServidor2 + segundosServidor3 + segundosServidor4)
                / cantidadServidores;
    ...
    private String checkStatus(byte[] serializado){
        ...
        try {
            ...
            try {
                ...
                aggregator.sendTasksToWorkers(Arrays.asList(checkStatus4), serializado);
